...
class SQLProductoSucursal 
{
	 ...
	 */
	public long adicionarProductoSucursal (PersistenceManager pm, long idSucursal, long idProducto) 
	{
	 ...
	 */
	public long eliminarProductoSucursal (PersistenceManager pm, long idSucursal, long idProducto) 
	{
	 ...
	 */
	public List<Supermercado> darProductoSucursal (PersistenceManager pm)
	{
		Query q = pm.newQuery(SQL, "SELECT * FROM " + pp.darTablaProductoSucursal ());
		q.setResultClass(Supermercado.class);
		return (List<Supermercado>) q.execute();
	}		 	
}
