...
import uniandes.isis2304.parranderos.negocio.VOCiudad;
import uniandes.isis2304.parranderos.negocio.VOPromocion;
import uniandes.isis2304.parranderos.negocio.VOBodega;
import uniandes.isis2304.parranderos.negocio.VONivelDeReorden;
...
//			e.printStackTrace ();
    ...
    public void demoTipoBebida( )
    {
    	try 
    	{
			...
			String resultado = "Demo de creación y listado de ProductoSucursal\n\n";
...
//			e.printStackTrace();
	...
	public void demoBebida( )
    {
    	try 
    	{
			...
			VOPromocion bebida = parranderos.adicionarBebida(nombreBebida, tipoBebida.getId (), 10);
			
			List <VOProductoSucursal> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOPromocion> listaBebidas = parranderos.darVOPromociones();
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas1 ( )
    {
    	try 
    	{
			...
			VOPromocion bebida1 = parranderos.adicionarBebida("120", tipoBebida.getId (), 10);
			VOPromocion bebida2 = parranderos.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOPromocion bebida3 = parranderos.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			
			List <VOProductoSucursal> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOPromocion> listaBebidas1 = parranderos.darVOPromociones();
			List <VONivelDeReorden> listaSirven = parranderos.darVOSirven ();
			long noServidasEliminadas = parranderos.eliminarBebidasNoServidas();
			List <VOPromocion> listaBebidas2 = parranderos.darVOPromociones();
			
			long bebEliminadas1 = parranderos.eliminarPromoPorId(bebida1.getId ());
			long bebEliminadas2 = parranderos.eliminarPromoPorId(bebida2.getId ());
			long bebEliminadas3 = parranderos.eliminarPromoPorId(bebida3.getId ());
...
//			e.printStackTrace();
     ...
     * Demostración de creación y borrado de bebidas no servidas.
     * Incluye también los tipos de bebida pues el tipo de bebida es llave foránea en las bebidas
     * Incluye también los bares pues son llave foránea en la relación NivelDeReorden
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			List <VOProductoSucursal> listaTiposBebida = parranderos.darVOTiposBebida();
			List <VOPromocion> listaBebidas1 = parranderos.darVOPromociones();
			List <VOEmpresa> bares = parranderos.darVOEmpresas ();
			List <VONivelDeReorden> sirven = parranderos.darVOSirven ();
			long noServidasEliminadas = parranderos.eliminarBebidasNoServidas();
			List <VOPromocion> listaBebidas2 = parranderos.darVOPromociones();
			...
			long bebEliminadas3 = parranderos.eliminarPromoPorId(bebida3.getId ());
			long tbEliminados = parranderos.eliminarTipoBebidaPorNombre (nombreTipoBebida);
			long baresEliminados = parranderos.eliminarEmpresaPorNombre ("Los Amigos");
			...
			resultado += "\n" + listarBebidas (listaBebidas2);
			resultado += "\n\n************ Limpiando la base de datos ************ \n";
			resultado += sirvenEliminados + " NivelDeReorden eliminados\n";
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOEmpresa> lista = parranderos.darVOEmpresas ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			VOPromocion bebida1 = parranderos.adicionarBebida ("120", tipoBebida.getId (), 10);
			VOPromocion bebida2 = parranderos.adicionarBebida ("121", tipoBebida.getId (), 10);
			VOPromocion bebida3 = parranderos.adicionarBebida ("122", tipoBebida.getId (), 10);
			VOPromocion bebida4 = parranderos.adicionarBebida ("123", tipoBebida.getId (), 10);
			VOPromocion bebida5 = parranderos.adicionarBebida ("124", tipoBebida.getId (), 10);
			VOEmpresa bar1 = parranderos.adicionarEmpresa ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOEmpresa bar2 = parranderos.adicionarEmpresa ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOEmpresa bar3 = parranderos.adicionarEmpresa ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOEmpresa bar4 = parranderos.adicionarEmpresa ("Los Amigos4", "Medellín", "Bajo", 5);
			parranderos.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			...
			List <VOProductoSucursal> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOPromocion> listaBebidas = parranderos.darVOPromociones ();
			List <VOEmpresa> listaBares = parranderos.darVOEmpresas ();
			List <VONivelDeReorden> listaSirven = parranderos.darVOSirven ();
			...
			long baresEliminados = parranderos.eliminarEmpresaPorNombre ("Los Amigos1");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos2");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos3");
			baresEliminados += parranderos.eliminarEmpresaPorNit (bar4.getId ());
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			List <VOEmpresa> listaBares2 = parranderos.darVOEmpresas ();

			long baresEliminados = parranderos.eliminarEmpresaPorNit (bar1.getId ());
			baresEliminados += parranderos.eliminarEmpresaPorNit (bar2.getId ());
			baresEliminados += parranderos.eliminarEmpresaPorNit (bar3.getId ());
			baresEliminados += parranderos.eliminarEmpresaPorNit (bar4.getId ());
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
			...
			VOCiudad bdor2 = parranderos.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOCiudad bdor3 = parranderos.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOCiudad> bebedores = parranderos.darVOCiudades();
			VOCiudad bdor5 = parranderos.darCiudadPorId(bdor1.getId ());
			VOCiudad bdor6 = parranderos.darCiudadPorId(0);
			List <VOCiudad> pepitos = parranderos.darVOCiudadesPorNombre("Pepito");
			List <VOCiudad> pedritos = parranderos.darVOCiudadesPorNombre("Pedrito");
			
			long pepitosEliminados = parranderos.eliminarCiudadPorNombre ("Pepito");
			long pedritosEliminados = parranderos.eliminarCiudadPorNombre ("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			List <VOProductoSucursal> listaTipos = parranderos.darVOTiposBebida();
			List <VOPromocion> listaBebidas = parranderos.darVOPromociones();
			List <VOEmpresa> listaBares = parranderos.darVOEmpresas ();
			List <VOCiudad> bebedores = parranderos.darVOCiudades();
			List <VOBodega> listaGustan = parranderos.darVOGustan();
			List <VOSupermercado> listaVisitan = parranderos.darVOVisitan();

			VOCiudad bdor2 = parranderos.darBebedorCompleto(bdor1.getId ());
			...
			resultado += "\n\n************ Limpiando la base de datos ************ \n";
			resultado += gustanEliminados + " Bodega eliminados\n";
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOCiudad> bebedores1 = parranderos.darVOCiudades ();
			long bebedoresActualizados = parranderos.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOCiudad> bebedores2 = parranderos.darVOCiudades ();
			
			long bebedoresEliminados = parranderos.eliminarCiudadPorNombre ("Pepito");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOEmpresa bar4 = parranderos.adicionarEmpresa ("Los Amigos4", "Medellín", "Bajo", 5);
			VOCiudad bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOCiudad bdor2 = parranderos.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOCiudad bdor3 = parranderos.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOCiudad bdor4 = parranderos.adicionarBebedor ("Luis", "Cartagena", "Medio");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			...
			List<VOEmpresa> bares = parranderos.darVOEmpresas();
			List<VOCiudad> bebedores = parranderos.darVOCiudades();
			List<VOSupermercado> visitan = parranderos.darVOVisitan ();
			...
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos2");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos3");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOEmpresa bar4 = parranderos.adicionarEmpresa ("Los Amigos4", "Medellín", "Bajo", 5);
			VOCiudad bdor1 = parranderos.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOCiudad bdor2 = parranderos.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOCiudad bdor3 = parranderos.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			parranderos.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			parranderos.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			...
			long [] elimBdor1 = parranderos.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long [] elimBdor2 = parranderos.eliminarBebedorYVisitas_v1 (bdor2.getId ());
			long elimBdor3 = parranderos.eliminarCiudadPorId (bdor3.getId ());
			long baresEliminados = parranderos.eliminarEmpresaPorNombre ("Los Amigos1");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos2");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos3");
			baresEliminados += parranderos.eliminarEmpresaPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
	 ...
	 *****************************************************************/
    /**
     * Demostración de creación, consulta y borrado de la relación Bodega
    ...
    public void demoGustan ( )
    {
		try 
		{
			...
			List <VOProductoSucursal> listaTiposBebida = parranderos.darVOTiposBebida ();
			List <VOPromocion> listaBebidas = parranderos.darVOPromociones ();
			List <VOCiudad> listaBebedores = parranderos.darVOCiudades ();
			List <VOBodega> listaGustan = parranderos.darVOGustan();
			long gustanEliminados = parranderos.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = parranderos.eliminarBebidaPorNombre ("120");
			long tbEliminados = parranderos.eliminarTipoBebidaPorNombre ("Vino tinto");
			...
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
			String resultado = "Demo de creación y listado de Bodega\n\n";
			resultado += "\n\n************ Generando datos de prueba ************ \n";
			if (errorTipoBebida)
			{
				resultado += "*** Exception creando tipo de bebida !!\n";
...
//			e.printStackTrace();
	...
	/* ****************************************************************
	 * 			Demos de NivelDeReorden
	 *****************************************************************/
    /**
     * Demostración de creación, consulta y borrado de la relación NivelDeReorden
     * Incluye el manejo de Bares
     * Incluye el manejo de tipos de bebida
     * Incluye el manejo de Bebidas
     * Muestra la traza de la ejecución en el panelDatos
    ...
    public void demoSirven ( )
    {
		try 
		{
			...
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
			String resultado = "Demo de creación y listado de NivelDeReorden\n\n";
			resultado += "\n\n************ Generando datos de prueba ************ \n";
			if (errorTipoBebida)
			{
				resultado += "*** Exception creando tipo de bebida !!\n";
...
//			e.printStackTrace();
	...
	/* ****************************************************************
	 * 			Demos de Supermercado
	 *****************************************************************/
    /**
     * Demostración de creación, consulta y borrado de la relación Supermercado
     * Incluye el manejo de Bebedores
     * Incluye el manejo de Bares
     * Muestra la traza de la ejecución en el panelDatos
     * 
    ...
    public void demoVisitan ( )
    {
		try 
		{
			...
			long baresEliminados = parranderos.eliminarEmpresaPorNombre ("Los Amigos1");
			long bebedoresEliminadas = parranderos.eliminarCiudadPorNombre ("Pepito");
			
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
			String resultado = "Demo de creación y listado de Supermercado\n\n";
			resultado += "\n\n************ Generando datos de prueba ************ \n";
			resultado += "\n" + listarBares (listaBares);
			resultado += "\n" + listarBebedores (listaBebedores);
			resultado += "\n\n************ Ejecutando la demo ************ \n";
			resultado += "\n" + listarVisitan (listaVisitan);
			resultado += "\n\n************ Limpiando la base de datos ************ \n";
			resultado += visitanEliminados + " Supermercado eliminados\n";
...
//			e.printStackTrace();
	...
	public void limpiarBD ()
	{
		...
		{
    		// Ejecución de la demo y recolección de los resultados
			long eliminados [] = parranderos.limpiarSuperAndes();
...
//			e.printStackTrace();
     ...
     */
    private String listarBebedores (List<VOCiudad> lista) 
    {
    	String resp = "Los bebedores existentes son:\n";
    	int i = 1;
        for (VOCiudad bdor : lista)
        {
